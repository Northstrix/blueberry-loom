...
export interface RiggedInputProps {
  label: string;
  value: string;
...
const RiggedInput: React.FC<RiggedInputProps> = ({
  label,
  value,
  onValueChange,
  type = "text",
  ...
  const style: React.CSSProperties = {
    ...
    ...(textarea && textareaHeight ? { "--floating-input-layout-text-area-height": textareaHeight } : {}),
  ...
  return (
    <div className={groupClass} style={style}>
      ...
      <style jsx>{`
        ...
        /* Active (input focused or alwaysActive) */
